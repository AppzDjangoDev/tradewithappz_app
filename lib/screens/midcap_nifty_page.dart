...
class MidcapNiftyPage extends StatelessWidget {
  const MidcapNiftyPage({super.key});

  @override
  Widget build(BuildContext context) {
    return OptionChainViewMidcapknifty(
      cardInfos: midcpNiftyCardInfo,
      ...
      webSocketUrl: 'wss://93bd-2401-4900-9078-8c79-6cba-2d1b-fdf9-d8c4.ngrok-free.app/ws/fyersindexdata/MIDCPNIFTY/',
    );
  }
}

class OptionChainViewMidcapknifty extends StatefulWidget {
  ...
  const OptionChainViewMidcapknifty({
    super.key,
  ...
  @override
  _OptionChainViewMidcapkniftyState createState() => _OptionChainViewMidcapkniftyState();
}

class _OptionChainViewMidcapkniftyState extends State<OptionChainViewMidcapknifty> {
...
enum CardInfo {
  ...
  bankMidcapknifty('BANKNIFTY', 'Running : 52000'),
...
const bankMidcapkniftyCardInfo = [
  CardInfo.bankMidcapknifty,
  CardInfo.portfolio,
];
