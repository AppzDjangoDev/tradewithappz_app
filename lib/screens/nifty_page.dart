...
class NiftyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OptionChainViewNifty(
      cardInfos: niftyCardInfo,
      ...
      webSocketUrl: 'wss://93bd-2401-4900-9078-8c79-6cba-2d1b-fdf9-d8c4.ngrok-free.app/ws/fyersindexdata/NIFTY50/',
    );
  }
}

class OptionChainViewNifty extends StatefulWidget {
  ...
  @override
  _OptionChainViewNiftyState createState() => _OptionChainViewNiftyState();
}

class _OptionChainViewNiftyState extends State<OptionChainViewNifty> {
