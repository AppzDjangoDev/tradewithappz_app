...
//     try {
//       final url = 'https://3a4a-2401-4900-6671-6213-c9fa-ec22-8bdf-8492.ngrok-free.app/api/logout/';
...
//               ),
//               SalomonBottomBarItem(
//                 icon: const Icon(Icons.control_camera, size: 30),
...
class _HomePageState extends State<HomePage> {
  ...
  static const List<String> _webSocketUrls = [
    ...
    'wss://example.com/midcap-nifty',
    'wss://example.com/finnifty',
    'wss://example.com/banknifty',
    'wss://example.com/nifty',
    '',
  ];
  ...
  Future<void> _retrieveCSRFToken() async {
    final url =
        'https://3a4a-2401-4900-6671-6213-c9fa-ec22-8bdf-8492.ngrok-free.app/api/csrf-token/'; // Replace with your actual CSRF endpoint
    try {
      final response = await http.get(Uri.parse(url));
      if (response.statusCode == 200) {
        final cookies = response.headers['set-cookie'];
